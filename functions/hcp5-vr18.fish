function hcp5-vr18-deactivate --description "deativate hcp5 (VR18)"
  set -e Target
  set -e Debug
  set -e ParallelBuild
  set -e WS
...
function hcp5-vr18 --description "HCP5 Project setup (VR18)"

  set -gx WS /media/more/hcp5/ws/audi-hcp5-VR18
  cd $WS
  rvm ruby-2.7.1@hcp5
